...
class ActivityMetricDelegate: MetricDelegate {
    ...
    func getBlankStateText() -> String {
        return "Welcome! It looks like you don’t have any higi points. Higi points are rewarded for tracking your health. Be it checking your vitals at a higi Station or counting steps with an activity tracker, higi wants to reward you for keeping tabs on your health.";
    }
